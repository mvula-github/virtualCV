...
export const WORK_XP = [
  {
    ...
    title: "Student Assistant - GUI Programming",
    date: "July 2023 - October 2023",
    duties: [
      "Facilitated student learning by providing in-class support during lectures",
      "Delivered one-on-one guidance to students, enhancing their understanding of programming concepts.",
      "Assessed and graded projects demos, ensuring constructive and actionable feedback to improve student performance.",
    ],
  },
  {
    employer: "North West University",
